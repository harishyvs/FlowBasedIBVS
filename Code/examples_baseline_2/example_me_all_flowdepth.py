...
import argparse
import demo_runner_me_all_final_flowdepth as dr
...
# print("harish")
os.chdir("/home/yvsharish/ICRA/Flow_Net/flownet2/scripts/")
# os.system("python2 run-flownet.py /home/yvsharish/ICRA/Flow_Net/flownet2/models/FlowNet2-CSS-ft-sd/FlowNet2-CSS-ft-sd_weights.caffemodel.h5 /home/yvsharish/ICRA/Flow_Net/flownet2/models/FlowNet2-CSS-ft-sd/FlowNet2-CSS-ft-sd_deploy.prototxt.template /home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00000.png /home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00019.png out_single_1.flo")
os.chdir("/home/yvsharish/test/flownet2-tf")
##################
#command="/home/yvsharish/test/test_tf/bin/python -m src.flownet2.test --input_a /home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00000.png --input_b /home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00019.png --out /home/yvsharish/test/output_dir"

#command= "/home/yvsharish/test/tf_flownet2/demo.py --input_a "+"/home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00000.png"+" --input_b /home/yvsharish/working/habitat-sim/image_baseline_2/test.rgba.00019.png --out ./"
###########
#os.system(command)
...
#
#     command= "python2 run-flownet_baseline_2.py /home/harish/RRC/ICRA_2019/Flow_Net/flownet2/models/FlowNet2-CSS-ft-sd/FlowNet2-CSS-ft-sd_weights.caffemodel.h5 /home/harish/RRC/ICRA_2019/Flow_Net/flownet2/models/FlowNet2-CSS-ft-sd/FlowNet2-CSS-ft-sd_deploy.prototxt.template "+ str(frames)+" /home/harish/RRC/ICRA_2019/habitat-sim/image_baseline_2/test.rgba.00019.png out_single_1.flo"
#     os.system(command)
#
#     os.chdir("/home/harish/RRC/ICRA_2019/baseline_2/")
