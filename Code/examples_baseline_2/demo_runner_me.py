...
class DemoRunner:
    ...
    def save_color_observation(self, obs, total_frames):
        ...
        color_img.save("/home/harish/RRC/ICRA_2019/habitat-sim/image_baseline_2_output/test.rgba.%05d.png" % total_frames)
    ...
    def save_depth_observation(self, obs, total_frames):
        if self._sim_settings["depth_sensor"]:
            ...
            depth_img.save("/home/harish/RRC/ICRA_2019/habitat-sim/image_baseline_2_output/test.depth.%05d.png" % total_frames)
    ...
    def example(self,Vx,Vy,Vz,Wx,Wy,Wz,harish):
        ...
        while photo_error>1000:
            f_1=open("/home/harish/RRC/ICRA_2019/baseline_2/aaaaa/baseline_2_exp.txt","a+")
            f_1_indiv=open("/home/harish/RRC/ICRA_2019/baseline_2/aaaaa/baseline_2_exp_indi.txt","w")
            print(harish)
            with open("/home/harish/RRC/ICRA_2019/baseline_2/aaaaa/baseline_2_velocities_single_1.txt") as f:
                content = f.readlines()
            # print(content)
            ...
            with open("/home/harish/RRC/ICRA_2019/baseline_2/aaaaa/baseline_2_after_change.txt") as f:
                content = f.readlines()
            # print(content)
            content = [x.strip() for x in content]
            mat_ = []
            for line in content:
                ...
                if  len(s) == 7:
                    mat_.append(s)
            state.position=[float(mat_[harish][0]),float(mat_[harish][1]),float(mat_[harish][2])]
