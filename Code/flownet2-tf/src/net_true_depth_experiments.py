...
class Net(object):
    ...
    def test(self, checkpoint, out_path, save_image=True, save_flo=True):
        ...
        saver = tf.train.Saver()
        avg_flow_path = os.path.join('/home/yvsharish/working/aaaaa/baseline_2_avg_flow.txt')
        with tf.Session() as sess:
            ...
            while True:
                ...
                while True:
                    ...
                    print("len of pred_flow_np",len(pred_flow_np))
                    save_flo = True
                    ...
                    if save_image:
                        ...
                        imsave(full_out_path, flow_img)
                        f.write("Average Flow "+str(data).zfill(5)+" : "+str(avg_flow)+"\n")        
