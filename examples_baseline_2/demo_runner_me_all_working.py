...
class DemoRunner:
    ...
    def example(self,Vx,Vy,Vz,Wx,Wy,Wz,harish):
        ...
        while photo_error>1000:
            ...
            f_1_indiv=open("/home/yvsharish/working/aaaaa/baseline_2_exp_indi.txt","w")
            print(harish)
            with open("/home/yvsharish/working/aaaaa/baseline_2_velocities_single_1_new.txt") as f:
                content = f.readlines()
            # print(content)
            ...
            with open("/home/yvsharish/working/aaaaa/baseline_2_after_change.txt") as f:
                content = f.readlines()
            # print(content)
            content = [x.strip() for x in content]
            mat_ = []
            ...
            file_in=open("/home/yvsharish/working/aaaaa/baseline_2_photo.txt","r")
